    ...
    <>
      <div className="flex flex-col justify-center items-center mx-48 gap-5 font-medium">
        ...
        <div className="flex flex-col md:flex-row py-1 px-8 text-xs items-center gap-3">
          ...
          <div className="flex flex-col md:flex-row gap-3 font-light">
            <p
              className={cn(
                "px-4 py-1 rounded-lg border-white border cursor-pointer text-white bg-blue-900 transition duration-500 ease-in-out hover:text-blue-900 hover:bg-white hover:border-blue-900",
                toggleStateA === 1 ? "bg-white text-blue-900 border-blue-900" : "",
              )}
            ...
            <p
              className={cn(
                "px-4 py-1 rounded-lg border-white border cursor-pointer text-white bg-blue-900 transition duration-500 ease-in-out hover:text-blue-900 hover:bg-white hover:border-blue-900",
                toggleStateA === 2 ? "bg-white text-blue-900 border-blue-900" : "",
              )}
            ...
            <p
              className={cn(
                "px-4 py-1 rounded-lg border-white border cursor-pointer text-white bg-blue-900 transition duration-500 ease-in-out hover:text-blue-900 hover:bg-white hover:border-blue-900",
                toggleStateA === 3 ? "bg-white text-blue-900 border-blue-900" : "",
              )}
